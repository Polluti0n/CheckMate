...
export const formConfig = {
    common: [
        { name: "checkNumber", label: "Check Number", type: "text", required: true, autocomplete: "off" },
        { name: "date", label: "Date Received", type: "date", required: true, autocomplete: "off" },
        { name: "associationName", label: "Association Name", type: "text", required: true, autocomplete: "on",colSpan: 2 },
        { name: "amount", label: "Amount", type: "number", required: true, step: "0.01", min: "0", autocomplete: "off" },
        { name: "payee", label: "Payee", type: "text", required: true, autocomplete: "off" },
    ],
    [CheckCategory.HOMEOWNER_LOCKBOX]: [
        { name: "payor", label: "Homeowner Name", type: "text", required: true, autocomplete: "off" },
        { name: "clientAccountNumber", label: "Account Number", type: "text", required: true, autocomplete: "off" },
    ...
    [CheckCategory.MISC_NON_HOMEOWNER_INCOME]: [
        { name: "payor", label: "Payor", type: "text", required: true, autocomplete: "off" },
        { name: "department", label: "Department", type: "datalist", required: true, autocomplete: "off", options: departmentOptions },
        { name: "glCode", label: "GL Code", type: "text", required: true, autocomplete: "on" },

...
export const CheckMateLogo = ({ className }: { className?: string }) => (
    <svg className={className || "w-8 h-8"} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M20 0L26.1803 13.8197L40 20L26.1803 26.1803L20 40L13.8197 26.1803L0 20L13.8197 13.8197L20 0Z" fill="url(#paint0_linear_1_2)"/>
        <path d="M22.5 19.33L18.75 23L16.25 20.5" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        <defs>

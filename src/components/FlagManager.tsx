                        ...
                        <h4 className="text-md font-medium text-gray-800">{editingFlag?.id ? 'Edit Flag' : 'Add New Flag'}</h4>
                         <div className="mt-2 space-y-3">
                            <input 
                                ...
                                className="w-full bg-slate-50 border border-slate-300 text-slate-900 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-sky-300"
                            />
